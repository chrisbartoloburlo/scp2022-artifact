...
object MonitoredClient  {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val mon = new Monitor(new ServerConnectionManager(args(3).toInt), out, 300, 0.6745, args(4).toBoolean)(global, timeout) //25
    ...
    monThread.start()
    ClientLogic(in, args(0), args(5), args(1).toInt, args(2).toInt)(global, timeout)
  }
}
...
object Client {
  ...
  def main(args: Array[String]): Unit = {
    ...
    ClientLogic(c, args(0), args(4), args(1).toInt, args(2).toInt)(global, timeout)
  }
